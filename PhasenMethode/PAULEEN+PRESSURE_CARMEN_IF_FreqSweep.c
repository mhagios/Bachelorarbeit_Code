...
ua_float_t 		f_Kapazitaet_CP_A = 0.0f; //Variablen fuer Messung des Amplitudengangs
ua_float_t 		f_Kapazitaet_CR_A = 0.0f; //Variablen fuer Messung des Amplitudengangs

ua_float_t		f_Kapazitaet_CP_P = 0.0f; //Variablen fuer Messung der Phasenverschiebung
...
void ua_main()
{
	...
	while(1)
	{
		...
		{	
			...
			f32DDS_Frequency = (ua_float_t)CLK_IN_HZ * FloatInverse(16.0f * (ua_float_t)(Frequency_number + 28));
			// if((int)(f32DDS_Frequency) <= 3,700,000) 	//5.0 mW
			// {
			// 	s25DAC_CONF_MODE = (0b111);
			// }
			// if((int)(f32DDS_Frequency) <= 2,000,000)	//3.2 mW
			// {
			// 	s25DAC_CONF_MODE = (0b110);
			// }
			// if((int)(f32DDS_Frequency) <= 1,000,000)	//2.4 mW
			// {
			// 	s25DAC_CONF_MODE = (0b101);
			// }
			// if((int)(f32DDS_Frequency) <= 500,000)		//1.4 mW
			// {
			// 	s25DAC_CONF_MODE = (0b100);
			// }
			// if((int)(f32DDS_Frequency) <= 200,000)		//1.2 mW
			// {
			// 	s25DAC_CONF_MODE = (0b011);
			// }
			// if((int)(f32DDS_Frequency) <= 100,000)		//1.0 mW
			// {
			// 	s25DAC_CONF_MODE = (0b010);
			// }
			// if((int)(f32DDS_Frequency) <= 50,000)		//<1.0 mW
			// {
			// 	s25DAC_CONF_MODE = (0b001);
			// }
			// if((int)(f32DDS_Frequency) <= 10,000)		//<0.8 mW
			// {
			// 	s25DAC_CONF_MODE = (0b000);
			// }
			s25DAC_CONF_MODE = (0b010); // <100 kHz and 1.0 mW
			...
			UA_INCREMENT1_DDS = (ua_int_t)(f32DDS_Frequency * 9.10222222222f); //9.10222222222f = 2^28/fClk
			...
			Current_ADC_divider = Frequency_number + 28;
