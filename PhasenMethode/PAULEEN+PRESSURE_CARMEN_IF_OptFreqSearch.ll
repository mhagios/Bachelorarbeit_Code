; ModuleID = 'C:\Users\i40014121\Desktop\Bachelorarbeit_Code\PhasenMethode\PAULEEN+PRESSURE_CARMEN_IF_OptFreqSearch.c'
...
if.then5:                                         ; preds = %if.end
  ...
  %15 = load i128** @UA_DDS_REG_IN6_regptr, align 8
  store i128 1023, i128* %15, align 16
...
if.then8:                                         ; preds = %if.end6
  ...
  %19 = load i128** @UA_DDS_REG_IN6_regptr, align 8
  store i128 1023, i128* %19, align 16
  %20 = load i128** @UA_OUTPUT_SET_regptr, align 8
  store i128 256, i128* %20, align 16
  br label %if.end9
...
if.then11:                                        ; preds = %if.end9
  %22 = load i128** @UA_DAC_CONFIG_regptr, align 8
  store i128 229, i128* %22, align 16
  %23 = load i128** @UA_DDS_REG_IN6_regptr, align 8
  store i128 1023, i128* %23, align 16
  %24 = load i128** @UA_OUTPUT_SET_regptr, align 8
  store i128 256, i128* %24, align 16
  br label %if.end12

if.end12:                                         ; preds = %if.then11, %if.end9
  %25 = load i32* @Frequency_number, align 4
  %cmp13 = icmp eq i32 %25, 3
  br i1 %cmp13, label %if.then14, label %if.end15

if.then14:                                        ; preds = %if.end12
  %26 = load i128** @UA_DAC_CONFIG_regptr, align 8
  store i128 228, i128* %26, align 16
  %27 = load i128** @UA_DDS_REG_IN6_regptr, align 8
  store i128 1023, i128* %27, align 16
...
if.end18:                                         ; preds = %if.then17, %if.end15
  ...
  %cmp19 = icmp eq i32 %33, 5
  br i1 %cmp19, label %if.then20, label %if.end21

if.then20:                                        ; preds = %if.end18
  %34 = load i128** @UA_DAC_CONFIG_regptr, align 8
  store i128 227, i128* %34, align 16
  %35 = load i128** @UA_DDS_REG_IN6_regptr, align 8
  store i128 1023, i128* %35, align 16
  %36 = load i128** @UA_OUTPUT_SET_regptr, align 8
  store i128 256, i128* %36, align 16
  br label %if.end21

if.end21:                                         ; preds = %if.then20, %if.end18
  %37 = load i32* @Frequency_number, align 4
  %cmp22 = icmp eq i32 %37, 6
  br i1 %cmp22, label %if.then23, label %if.end24

if.then23:                                        ; preds = %if.end21
  %38 = load i128** @UA_DAC_CONFIG_regptr, align 8
  store i128 226, i128* %38, align 16
  %39 = load i128** @UA_DDS_REG_IN6_regptr, align 8
  store i128 1023, i128* %39, align 16
...
if.end24:                                         ; preds = %if.then23, %if.end21
  ...
  %cmp25 = icmp eq i32 %41, 7
  br i1 %cmp25, label %if.then26, label %if.end27

if.then26:                                        ; preds = %if.end24
  %42 = load i128** @UA_DAC_CONFIG_regptr, align 8
  store i128 225, i128* %42, align 16
  %43 = load i128** @UA_DDS_REG_IN6_regptr, align 8
  store i128 1023, i128* %43, align 16
  %44 = load i128** @UA_OUTPUT_SET_regptr, align 8
  store i128 256, i128* %44, align 16
  br label %if.end27

if.end27:                                         ; preds = %if.then26, %if.end24
  %45 = load i32* @Frequency_number, align 4
  %cmp28 = icmp eq i32 %45, 8
  br i1 %cmp28, label %if.then29, label %if.end30

if.then29:                                        ; preds = %if.end27
  %46 = load i128** @UA_DAC_CONFIG_regptr, align 8
  store i128 225, i128* %46, align 16
  %47 = load i128** @UA_DDS_REG_IN6_regptr, align 8
  store i128 1023, i128* %47, align 16
  %48 = load i128** @UA_OUTPUT_SET_regptr, align 8
  store i128 256, i128* %48, align 16
  br label %if.end30
...
if.end30:                                         ; preds = %if.then29, %if.end27
  ...
  %50 = load volatile i128* %arrayidx, align 16
  %51 = load i128** @UA_DDS_REG_IN1_regptr, align 8
  store i128 %50, i128* %51, align 16
  %52 = load i128** @UA_CONFIG_DDS_regptr, align 8
  store i128 2147483648, i128* %52, align 16
  ...
  %54 = load volatile i32* %arrayidx32, align 4
  store i32 %54, i32* @Current_ADC_divider, align 4
  %55 = load i128** @UA_ADC_MEM_PTR_regptr, align 8
  %56 = load i128* %55, align 16
  %conv = trunc i128 %56 to i32
  %sub = sub nsw i32 %conv, 1
  store i32 %sub, i32* @Last_ADC_Pointer, align 4
  %57 = load i32* @Current_ADC_divider, align 4
  %conv33 = sext i32 %57 to i128
  %58 = load i128** @UA_ADC_CONVERSION_TIME_regptr, align 8
  store i128 %conv33, i128* %58, align 16
  %59 = load i128** @UA_ADC_CONVERSION_CONF_regptr, align 8
  store i128 1, i128* %59, align 16
  %60 = load i32* @Cycle_Number, align 4
  %inc = add nsw i32 %60, 1
  store i32 %inc, i32* @Cycle_Number, align 4
  %61 = load i32* @Current_ADC_divider, align 4
  %conv34 = sitofp i32 %61 to float
  %add = fadd float %conv34, 2.800000e+01
  %mul = fmul float %add, 2.500000e-01
  store float %mul, float* %in.addr.i, align 4
  %62 = load float* %in.addr.i, align 4
  %add.i = fadd float %62, 0x3FEFFFFFE0000000
  %conv.i = fptosi float %add.i to i32
  store i32 %conv.i, i32* @MAX_UA_Cycle, align 4
  br label %if.end227

if.else35:                                        ; preds = %land.lhs.true, %while.body
  %63 = load i32* @Cycle_Number, align 4
  %64 = load i32* @MAX_UA_Cycle, align 4
  %cmp36 = icmp sge i32 %63, %64
  br i1 %cmp36, label %land.lhs.true38, label %if.else211

land.lhs.true38:                                  ; preds = %if.else35
  %65 = load i32* @Current_state, align 4
  %cmp39 = icmp eq i32 %65, 1
  br i1 %cmp39, label %if.then41, label %if.else211

if.then41:                                        ; preds = %land.lhs.true38
  store i32 0, i32* @Cycle_Number, align 4
  %66 = load i128** @UA_ADC_CONVERSION_CONF_regptr, align 8
  store i128 0, i128* %66, align 16
  %67 = load i128** @UA_CONFIG_DDS_regptr, align 8
  store i128 1073741824, i128* %67, align 16
  store i32 0, i32* %Zeroline_Temp, align 4
  store i32 0, i32* @Value_index, align 4
  br label %for.cond

for.cond:                                         ; preds = %for.inc65, %if.then41
  %68 = load i32* @Value_index, align 4
  %cmp42 = icmp slt i32 %68, 16
...
for.cond44:                                       ; preds = %for.inc, %for.body
  %69 = load i32* @period, align 4
  %cmp45 = icmp slt i32 %69, 16
  br i1 %cmp45, label %for.body47, label %for.end

for.body47:                                       ; preds = %for.cond44
  %70 = load i32* @Last_ADC_Pointer, align 4
  %71 = load i32* @period, align 4
  %mul48 = mul nsw i32 %71, 16
  %sub49 = sub nsw i32 %70, %mul48
  %72 = load i32* @Value_index, align 4
  %sub50 = sub nsw i32 %sub49, %72
  %and = and i32 %sub50, 1023
  %idxprom51 = sext i32 %and to i64
  %73 = load i32** @UA_ADC_MEM_regptr, align 8
  %arrayidx52 = getelementptr inbounds i32* %73, i64 %idxprom51
  %74 = load i32* %arrayidx52, align 4
  %75 = load i32* @Temp, align 4
  %add53 = add nsw i32 %74, %75
  store i32 %add53, i32* @Temp, align 4
  br label %for.inc

for.inc:                                          ; preds = %for.body47
  %76 = load i32* @period, align 4
  %inc54 = add nsw i32 %76, 1
  store i32 %inc54, i32* @period, align 4
  br label %for.cond44

for.end:                                          ; preds = %for.cond44
  %77 = load i32* @Current_signal, align 4
  %cmp55 = icmp eq i32 %77, 0
...
if.else60:                                        ; preds = %for.end
  ...
  store i32 %80, i32* %arrayidx62, align 4
  br label %if.end63

if.end63:                                         ; preds = %if.else60, %if.then57
  %82 = load i32* @Temp, align 4
  %83 = load i32* %Zeroline_Temp, align 4
  %add64 = add nsw i32 %83, %82
...
if.then78:                                        ; preds = %for.body75
  ...
  %90 = load i32* %arrayidx80, align 4
  %conv81 = sitofp i32 %90 to float
  %91 = load i32* @Current_signal, align 4
  %idxprom82 = sext i32 %91 to i64
  %arrayidx83 = getelementptr inbounds [2 x float]* @Zeroline, i32 0, i64 %idxprom82
  %92 = load float* %arrayidx83, align 4
  %sub84 = fsub float %conv81, %92
...
if.else85:                                        ; preds = %for.body75
  ...
  %94 = load i32* %arrayidx87, align 4
  %conv88 = sitofp i32 %94 to float
  ...
  %96 = load float* %arrayidx90, align 4
  %sub91 = fsub float %conv88, %96
  store float %sub91, float* @f_Temp, align 4
  br label %if.end92

if.end92:                                         ; preds = %if.else85, %if.then78
  %97 = load float* @f_Temp, align 4
  ...
  %99 = load volatile float* %arrayidx94, align 4
  %mul95 = fmul float %97, %99
  store float %mul95, float* @f_Q1, align 4
  %100 = load float* @f_Temp, align 4
  %101 = load i32* @Value_index, align 4
  %add96 = add nsw i32 %101, 4
  ...
  %102 = load volatile float* %arrayidx99, align 4
  %mul100 = fmul float %100, %102
  store float %mul100, float* @f_Q2, align 4
  %103 = load float* @f_Q1, align 4
  %104 = load float* @f_Q1m, align 4
  %add101 = fadd float %104, %103
  store float %add101, float* @f_Q1m, align 4
  %105 = load float* @f_Q2, align 4
  %106 = load float* @f_Q2m, align 4
  %add102 = fadd float %106, %105
  store float %add102, float* @f_Q2m, align 4
  %107 = load float* @f_Q1, align 4
  %108 = load float* @f_Q1, align 4
  %mul103 = fmul float %107, %108
  %109 = load float* @f_Q2, align 4
  %110 = load float* @f_Q2, align 4
  %mul104 = fmul float %109, %110
  %add105 = fadd float %mul103, %mul104
  %111 = load float* @f_Amplitude_Temp, align 4
  %add106 = fadd float %111, %add105
...
for.end109:                                       ; preds = %for.cond72
  %113 = load i32* @Current_signal, align 4
  %cmp110 = icmp eq i32 %113, 0
  br i1 %cmp110, label %if.then112, label %if.else113

if.then112:                                       ; preds = %for.end109
  %114 = load float* @f_Q2m, align 4
  store float %114, float* @Q2mSig, align 4
  %115 = load float* @f_Q1m, align 4
  store float %115, float* @Q1mSig, align 4
  br label %if.end114

if.else113:                                       ; preds = %for.end109
  %116 = load float* @f_Q2m, align 4
  store float %116, float* @Q2mRef, align 4
  %117 = load float* @f_Q1m, align 4
  store float %117, float* @Q1mRef, align 4
  br label %if.end114

if.end114:                                        ; preds = %if.else113, %if.then112
  %118 = load float* @f_Amplitude_Temp, align 4
  %mul115 = fmul float %118, 1.250000e-01
  store float %mul115, float* %number.addr.i396, align 4
  %119 = load float* %number.addr.i396, align 4
  %mul.i402 = fmul float %119, 5.000000e-01
  store float %mul.i402, float* %x2.i400, align 4
  %120 = load float* %number.addr.i396, align 4
  %conv.i403 = fptosi float %120 to i128
  store i128 %conv.i403, i128* %i.i397, align 16
  %121 = load i128* %i.i397, align 16
  %shr.i404 = ashr i128 %121, 1
  store i128 %shr.i404, i128* %i.i397, align 16
  %122 = load i128* %i.i397, align 16
  %and.i405 = and i128 %122, 65535
  %conv1.i406 = trunc i128 %and.i405 to i32
  store i32 %conv1.i406, i32* %i_lo.i398, align 4
  %123 = load i128* %i.i397, align 16
  %and2.i407 = and i128 %123, 2147418112
  %shr3.i408 = ashr i128 %and2.i407, 16
  %conv4.i409 = trunc i128 %shr3.i408 to i32
  store i32 %conv4.i409, i32* %i_hi.i399, align 4
  %124 = load i32* %i_lo.i398, align 4
  %sub.i410 = sub nsw i32 23007, %124
  store i32 %sub.i410, i32* %i_lo.i398, align 4
  %125 = load i32* %i_lo.i398, align 4
  %cmp.i411 = icmp slt i32 %125, 0
  br i1 %cmp.i411, label %if.then.i415, label %if.else.i417

if.then.i415:                                     ; preds = %if.end114
  %126 = load i32* %i_hi.i399, align 4
  %sub6.i412 = sub nsw i32 24375, %126
  %sub7.i413 = sub nsw i32 %sub6.i412, 1
  store i32 %sub7.i413, i32* %i_hi.i399, align 4
  %127 = load i32* %i_lo.i398, align 4
  %and8.i414 = and i32 %127, 65535
  store i32 %and8.i414, i32* %i_lo.i398, align 4
  br label %UA_sqrt.exit436

if.else.i417:                                     ; preds = %if.end114
  %128 = load i32* %i_hi.i399, align 4
  %sub9.i416 = sub nsw i32 24375, %128
  store i32 %sub9.i416, i32* %i_hi.i399, align 4
  br label %UA_sqrt.exit436

UA_sqrt.exit436:                                  ; preds = %if.then.i415, %if.else.i417
  %129 = load i32* %i_hi.i399, align 4
  %shl.i418 = shl i32 %129, 16
  %130 = load i32* %i_lo.i398, align 4
  %or.i419 = or i32 %shl.i418, %130
  %conv10.i420 = sext i32 %or.i419 to i128
  store i128 %conv10.i420, i128* %i.i397, align 16
  %131 = load i128* %i.i397, align 16
  %conv11.i421 = sitofp i128 %131 to float
  ...
  %mul12.i422 = fmul float %133, %134
  %135 = load float* %y.i401, align 4
  %mul13.i423 = fmul float %mul12.i422, %135
  %sub14.i424 = fsub float 1.500000e+00, %mul13.i423
  %mul15.i425 = fmul float %132, %sub14.i424
  store float %mul15.i425, float* %y.i401, align 4
  %136 = load float* %y.i401, align 4
  %137 = load float* %x2.i400, align 4
  %138 = load float* %y.i401, align 4
  %mul16.i426 = fmul float %137, %138
  %139 = load float* %y.i401, align 4
  %mul17.i427 = fmul float %mul16.i426, %139
  %sub18.i428 = fsub float 1.500000e+00, %mul17.i427
  %mul19.i429 = fmul float %136, %sub18.i428
  store float %mul19.i429, float* %y.i401, align 4
  %140 = load float* %y.i401, align 4
  %141 = load float* %x2.i400, align 4
  %142 = load float* %y.i401, align 4
  %mul20.i430 = fmul float %141, %142
  %143 = load float* %y.i401, align 4
  %mul21.i431 = fmul float %mul20.i430, %143
  %sub22.i432 = fsub float 1.500000e+00, %mul21.i431
  %mul23.i433 = fmul float %140, %sub22.i432
  store float %mul23.i433, float* %y.i401, align 4
  %144 = load float* %y.i401, align 4
  %145 = load float* %number.addr.i396, align 4
  %mul24.i434 = fmul float %144, %145
  %146 = load i32* @Current_signal, align 4
  ...
  %147 = load float* @f_Q2m, align 4
  %148 = load float* @f_Q1m, align 4
  store float %148, float* %in.addr.i370, align 4
  %149 = load float* %in.addr.i370, align 4
  %conv.i373 = fptosi float %149 to i128
  ...
  %mul.i377 = fmul float 0x3FFE1E1E20000000, %150
  %sub.i378 = fsub float 0x40069696A0000000, %mul.i377
  store float %sub.i378, float* %x.i372, align 4
  %151 = load float* %x.i372, align 4
  %152 = load float* %In_Reduced.i371, align 4
  %153 = load float* %x.i372, align 4
  %mul2.i379 = fmul float %152, %153
  %sub3.i380 = fsub float 2.000000e+00, %mul2.i379
  %mul4.i381 = fmul float %151, %sub3.i380
  store float %mul4.i381, float* %x.i372, align 4
  %154 = load float* %x.i372, align 4
  %155 = load float* %In_Reduced.i371, align 4
  %156 = load float* %x.i372, align 4
  %mul5.i382 = fmul float %155, %156
  %sub6.i383 = fsub float 2.000000e+00, %mul5.i382
  %mul7.i384 = fmul float %154, %sub6.i383
  store float %mul7.i384, float* %x.i372, align 4
  %157 = load float* %x.i372, align 4
  %158 = load float* %In_Reduced.i371, align 4
  %159 = load float* %x.i372, align 4
  %mul8.i385 = fmul float %158, %159
  %sub9.i386 = fsub float 2.000000e+00, %mul8.i385
  %mul10.i387 = fmul float %157, %sub9.i386
  store float %mul10.i387, float* %x.i372, align 4
  %160 = load float* %x.i372, align 4
  %conv11.i388 = fptosi float %160 to i128
  %and12.i389 = and i128 %conv11.i388, 8388607
  %161 = load float* %in.addr.i370, align 4
  %conv13.i390 = fptosi float %161 to i128
  ...
  %mul120 = fmul float %147, %mul17.i395
  store float %mul120, float* %x.addr.i, align 4
  %162 = load float* %x.addr.i, align 4
  store float %162, float* %t.i, align 4
  %163 = load float* %x.addr.i, align 4
  %cmp.i358 = fcmp olt float %163, 0.000000e+00
  br i1 %cmp.i358, label %if.then.i360, label %if.end.i

if.then.i360:                                     ; preds = %UA_sqrt.exit436
  %164 = load float* %x.addr.i, align 4
  %sub.i359 = fsub float -0.000000e+00, %164
  store float %sub.i359, float* %t.i, align 4
  br label %if.end.i

if.end.i:                                         ; preds = %if.then.i360, %UA_sqrt.exit436
  %165 = load float* %t.i, align 4
  store float %165, float* %r.i, align 4
  %166 = load float* %t.i, align 4
  %cmp1.i = fcmp ogt float %166, 1.000000e+00
  br i1 %cmp1.i, label %if.then2.i, label %if.end3.i

if.then2.i:                                       ; preds = %if.end.i
  %167 = load float* %r.i, align 4
  store float %167, float* %in.addr.i.i, align 4
  %168 = load float* %in.addr.i.i, align 4
  %conv.i.i = fptosi float %168 to i128
  ...
  %mul.i.i = fmul float 0x3FFE1E1E20000000, %169
  ...
  %mul2.i.i = fmul float %171, %172
  %sub3.i.i = fsub float 2.000000e+00, %mul2.i.i
  %mul4.i.i = fmul float %170, %sub3.i.i
  store float %mul4.i.i, float* %x.i.i, align 4
  %173 = load float* %x.i.i, align 4
  %174 = load float* %In_Reduced.i.i, align 4
  %175 = load float* %x.i.i, align 4
  %mul5.i.i = fmul float %174, %175
  %sub6.i.i = fsub float 2.000000e+00, %mul5.i.i
  %mul7.i.i = fmul float %173, %sub6.i.i
  store float %mul7.i.i, float* %x.i.i, align 4
  %176 = load float* %x.i.i, align 4
  %177 = load float* %In_Reduced.i.i, align 4
  %178 = load float* %x.i.i, align 4
  %mul8.i.i = fmul float %177, %178
  %sub9.i.i = fsub float 2.000000e+00, %mul8.i.i
  %mul10.i.i = fmul float %176, %sub9.i.i
  store float %mul10.i.i, float* %x.i.i, align 4
  %179 = load float* %x.i.i, align 4
  %conv11.i.i = fptosi float %179 to i128
  %and12.i.i = and i128 %conv11.i.i, 8388607
  %180 = load float* %in.addr.i.i, align 4
  %conv13.i.i = fptosi float %180 to i128
...
UA_atan.exit:                                     ; preds = %if.end24.i, %if.then26.i
  ...
  %209 = load i32* @Current_signal, align 4
  %cmp125 = icmp ne i32 %209, 0
  br i1 %cmp125, label %if.then127, label %if.end210

if.then127:                                       ; preds = %UA_atan.exit
  %210 = load i32* @s25_Switch_CP_CR, align 4
  %cmp128 = icmp eq i32 %210, 0
  br i1 %cmp128, label %if.then130, label %if.else166

if.then130:                                       ; preds = %if.then127
  %211 = load i128** @UA_OUTPUT_SET_regptr, align 8
  store i128 8192, i128* %211, align 16
  %212 = load float* @C_GainAmp_pF, align 4
  %213 = load i32* @Frequency_number, align 4
  %idxprom131 = sext i32 %213 to i64
  %arrayidx132 = getelementptr inbounds [9 x float]* @OneOn_WR, i32 0, i64 %idxprom131
  %214 = load volatile float* %arrayidx132, align 4
  %215 = load float* getelementptr inbounds ([2 x float]* @Amplitude, i32 0, i64 1), align 4
  %216 = load float* getelementptr inbounds ([2 x float]* @Amplitude, i32 0, i64 1), align 4
  %mul133 = fmul float %215, %216
  %217 = load float* getelementptr inbounds ([2 x float]* @Amplitude, i32 0, i64 0), align 4
  %218 = load float* getelementptr inbounds ([2 x float]* @Amplitude, i32 0, i64 0), align 4
  %mul134 = fmul float %217, %218
  store float %mul134, float* %in.addr.i332, align 4
  %219 = load float* %in.addr.i332, align 4
  %conv.i335 = fptosi float %219 to i128
  ...
  %mul.i339 = fmul float 0x3FFE1E1E20000000, %220
  %sub.i340 = fsub float 0x40069696A0000000, %mul.i339
  store float %sub.i340, float* %x.i334, align 4
  %221 = load float* %x.i334, align 4
  %222 = load float* %In_Reduced.i333, align 4
  %223 = load float* %x.i334, align 4
  %mul2.i341 = fmul float %222, %223
  %sub3.i342 = fsub float 2.000000e+00, %mul2.i341
  %mul4.i343 = fmul float %221, %sub3.i342
  store float %mul4.i343, float* %x.i334, align 4
  %224 = load float* %x.i334, align 4
  %225 = load float* %In_Reduced.i333, align 4
  %226 = load float* %x.i334, align 4
  %mul5.i344 = fmul float %225, %226
  %sub6.i345 = fsub float 2.000000e+00, %mul5.i344
  %mul7.i346 = fmul float %224, %sub6.i345
  store float %mul7.i346, float* %x.i334, align 4
  %227 = load float* %x.i334, align 4
  %228 = load float* %In_Reduced.i333, align 4
  %229 = load float* %x.i334, align 4
  %mul8.i347 = fmul float %228, %229
  %sub9.i348 = fsub float 2.000000e+00, %mul8.i347
  %mul10.i349 = fmul float %227, %sub9.i348
  store float %mul10.i349, float* %x.i334, align 4
  %230 = load float* %x.i334, align 4
  %conv11.i350 = fptosi float %230 to i128
  %and12.i351 = and i128 %conv11.i350, 8388607
  %231 = load float* %in.addr.i332, align 4
  %conv13.i352 = fptosi float %231 to i128
...
UA_sqrt.exit331:                                  ; preds = %if.then.i311, %if.else.i313
  ...
  %mul12.i318 = fmul float %246, %247
  %248 = load float* %y.i297, align 4
  %mul13.i319 = fmul float %mul12.i318, %248
  %sub14.i320 = fsub float 1.500000e+00, %mul13.i319
  %mul15.i321 = fmul float %245, %sub14.i320
  store float %mul15.i321, float* %y.i297, align 4
  %249 = load float* %y.i297, align 4
  %250 = load float* %x2.i296, align 4
  %251 = load float* %y.i297, align 4
  %mul16.i322 = fmul float %250, %251
  %252 = load float* %y.i297, align 4
  %mul17.i323 = fmul float %mul16.i322, %252
  %sub18.i324 = fsub float 1.500000e+00, %mul17.i323
  %mul19.i325 = fmul float %249, %sub18.i324
  store float %mul19.i325, float* %y.i297, align 4
  %253 = load float* %y.i297, align 4
  %254 = load float* %x2.i296, align 4
  %255 = load float* %y.i297, align 4
  %mul20.i326 = fmul float %254, %255
  %256 = load float* %y.i297, align 4
  %mul21.i327 = fmul float %mul20.i326, %256
  %sub22.i328 = fsub float 1.500000e+00, %mul21.i327
  %mul23.i329 = fmul float %253, %sub22.i328
  store float %mul23.i329, float* %y.i297, align 4
  %257 = load float* %y.i297, align 4
  %258 = load float* %number.addr.i292, align 4
  %mul24.i330 = fmul float %257, %258
  %mul139 = fmul float %214, %mul24.i330
  %259 = load float* @C_OffsetAmp_pF, align 4
  %sub140 = fsub float %mul139, %259
  %mul141 = fmul float %212, %sub140
  ...
  %261 = load float* @C_GainPhase_pF, align 4
  %262 = load i32* @Frequency_number, align 4
  %idxprom144 = sext i32 %262 to i64
  %arrayidx145 = getelementptr inbounds [9 x float]* @OneOn_WR, i32 0, i64 %idxprom144
  %263 = load volatile float* %arrayidx145, align 4
  %264 = load float* @Q2mRef, align 4
  %265 = load float* @Q1mSig, align 4
  %mul146 = fmul float %264, %265
  %266 = load float* @Q2mSig, align 4
  %267 = load float* @Q1mRef, align 4
  %mul147 = fmul float %266, %267
  %sub148 = fsub float %mul146, %mul147
  %mul149 = fmul float %263, %sub148
  %268 = load float* @Q1mSig, align 4
  %269 = load float* @Q1mRef, align 4
  %mul150 = fmul float %268, %269
  %270 = load float* @Q2mSig, align 4
  %271 = load float* @Q2mRef, align 4
  %mul151 = fmul float %270, %271
  %add152 = fadd float %mul150, %mul151
  store float %add152, float* %in.addr.i266, align 4
  %272 = load float* %in.addr.i266, align 4
  %conv.i269 = fptosi float %272 to i128
  ...
  %mul.i273 = fmul float 0x3FFE1E1E20000000, %273
  %sub.i274 = fsub float 0x40069696A0000000, %mul.i273
  store float %sub.i274, float* %x.i268, align 4
  %274 = load float* %x.i268, align 4
  %275 = load float* %In_Reduced.i267, align 4
  %276 = load float* %x.i268, align 4
  %mul2.i275 = fmul float %275, %276
  %sub3.i276 = fsub float 2.000000e+00, %mul2.i275
  %mul4.i277 = fmul float %274, %sub3.i276
  store float %mul4.i277, float* %x.i268, align 4
  %277 = load float* %x.i268, align 4
  %278 = load float* %In_Reduced.i267, align 4
  %279 = load float* %x.i268, align 4
  %mul5.i278 = fmul float %278, %279
  %sub6.i279 = fsub float 2.000000e+00, %mul5.i278
  %mul7.i280 = fmul float %277, %sub6.i279
  store float %mul7.i280, float* %x.i268, align 4
  %280 = load float* %x.i268, align 4
  %281 = load float* %In_Reduced.i267, align 4
  %282 = load float* %x.i268, align 4
  %mul8.i281 = fmul float %281, %282
  %sub9.i282 = fsub float 2.000000e+00, %mul8.i281
  %mul10.i283 = fmul float %280, %sub9.i282
  store float %mul10.i283, float* %x.i268, align 4
  %283 = load float* %x.i268, align 4
  %conv11.i284 = fptosi float %283 to i128
  %and12.i285 = and i128 %conv11.i284, 8388607
  %284 = load float* %in.addr.i266, align 4
  %conv13.i286 = fptosi float %284 to i128
  ...
  %285 = load float* @C_OffsetPhase_pF, align 4
  %sub155 = fsub float %mul154, %285
  %mul156 = fmul float %261, %sub155
  %286 = load i32* @Frequency_number, align 4
  %idxprom157 = sext i32 %286 to i64
  ...
  %287 = load i32* @Frequency_number, align 4
  %idxprom159 = sext i32 %287 to i64
  %arrayidx160 = getelementptr inbounds [9 x float]* @f_Kapazitaet_CP_A, i32 0, i64 %idxprom159
  %288 = load float* %arrayidx160, align 4
  %conv161 = fptosi float %288 to i128
  %289 = load i128** @UA_SERIAL_OUT_regptr, align 8
  store i128 %conv161, i128* %289, align 16
  %290 = load i32* @Frequency_number, align 4
  %idxprom162 = sext i32 %290 to i64
  %arrayidx163 = getelementptr inbounds [9 x float]* @f_Kapazitaet_CP_P, i32 0, i64 %idxprom162
  %291 = load float* %arrayidx163, align 4
  %conv164 = fptosi float %291 to i128
  %292 = load i128** @UA_SERIAL_OUT2_regptr, align 8
  store i128 %conv164, i128* %292, align 16
  %293 = load i32* @Frequency_number, align 4
  %shl = shl i32 %293, 8
  %or = or i32 %shl, 192
  %conv165 = sext i32 %or to i128
  %294 = load i128** @UA_SERIAL_OUT3_regptr, align 8
  store i128 %conv165, i128* %294, align 16
  br label %if.end205

if.else166:                                       ; preds = %if.then127
  %295 = load i128** @UA_OUTPUT_RESET_regptr, align 8
  store i128 8192, i128* %295, align 16
  %296 = load float* @C_GainAmp_pF, align 4
  %297 = load i32* @Frequency_number, align 4
  %idxprom167 = sext i32 %297 to i64
  %arrayidx168 = getelementptr inbounds [9 x float]* @OneOn_WR, i32 0, i64 %idxprom167
  %298 = load volatile float* %arrayidx168, align 4
  %299 = load float* getelementptr inbounds ([2 x float]* @Amplitude, i32 0, i64 1), align 4
  %300 = load float* getelementptr inbounds ([2 x float]* @Amplitude, i32 0, i64 1), align 4
  %mul169 = fmul float %299, %300
  %301 = load float* getelementptr inbounds ([2 x float]* @Amplitude, i32 0, i64 0), align 4
  %302 = load float* getelementptr inbounds ([2 x float]* @Amplitude, i32 0, i64 0), align 4
  %mul170 = fmul float %301, %302
  store float %mul170, float* %in.addr.i240, align 4
  %303 = load float* %in.addr.i240, align 4
  %conv.i243 = fptosi float %303 to i128
  ...
  %mul.i247 = fmul float 0x3FFE1E1E20000000, %304
  %sub.i248 = fsub float 0x40069696A0000000, %mul.i247
  store float %sub.i248, float* %x.i242, align 4
  %305 = load float* %x.i242, align 4
  %306 = load float* %In_Reduced.i241, align 4
  %307 = load float* %x.i242, align 4
  %mul2.i249 = fmul float %306, %307
  %sub3.i250 = fsub float 2.000000e+00, %mul2.i249
  %mul4.i251 = fmul float %305, %sub3.i250
  store float %mul4.i251, float* %x.i242, align 4
  %308 = load float* %x.i242, align 4
  %309 = load float* %In_Reduced.i241, align 4
  %310 = load float* %x.i242, align 4
  %mul5.i252 = fmul float %309, %310
  %sub6.i253 = fsub float 2.000000e+00, %mul5.i252
  %mul7.i254 = fmul float %308, %sub6.i253
  store float %mul7.i254, float* %x.i242, align 4
  %311 = load float* %x.i242, align 4
  %312 = load float* %In_Reduced.i241, align 4
  %313 = load float* %x.i242, align 4
  %mul8.i255 = fmul float %312, %313
  %sub9.i256 = fsub float 2.000000e+00, %mul8.i255
  %mul10.i257 = fmul float %311, %sub9.i256
  store float %mul10.i257, float* %x.i242, align 4
  %314 = load float* %x.i242, align 4
  %conv11.i258 = fptosi float %314 to i128
  %and12.i259 = and i128 %conv11.i258, 8388607
  %315 = load float* %in.addr.i240, align 4
  %conv13.i260 = fptosi float %315 to i128
...
UA_sqrt.exit:                                     ; preds = %if.then.i, %if.else.i
  ...
  %345 = load float* @C_GainPhase_pF, align 4
  %346 = load i32* @Frequency_number, align 4
  %idxprom180 = sext i32 %346 to i64
  %arrayidx181 = getelementptr inbounds [9 x float]* @OneOn_WR, i32 0, i64 %idxprom180
  %347 = load volatile float* %arrayidx181, align 4
  %348 = load float* @Q2mRef, align 4
  %349 = load float* @Q1mSig, align 4
  %mul182 = fmul float %348, %349
  %350 = load float* @Q2mSig, align 4
  %351 = load float* @Q1mRef, align 4
  %mul183 = fmul float %350, %351
  %sub184 = fsub float %mul182, %mul183
  %mul185 = fmul float %347, %sub184
  %352 = load float* @Q1mSig, align 4
  %353 = load float* @Q1mRef, align 4
  %mul186 = fmul float %352, %353
  %354 = load float* @Q2mSig, align 4
  %355 = load float* @Q2mRef, align 4
  %mul187 = fmul float %354, %355
  %add188 = fadd float %mul186, %mul187
  store float %add188, float* %in.addr.i228, align 4
  %356 = load float* %in.addr.i228, align 4
  %conv.i229 = fptosi float %356 to i128
  %and.i = and i128 %conv.i229, 8388607
  %or.i = or i128 %and.i, 1056964608
  %conv1.i = sitofp i128 %or.i to float
  store float %conv1.i, float* %In_Reduced.i, align 4
  %357 = load float* %In_Reduced.i, align 4
  %mul.i = fmul float 0x3FFE1E1E20000000, %357
  %sub.i = fsub float 0x40069696A0000000, %mul.i
  store float %sub.i, float* %x.i, align 4
  %358 = load float* %x.i, align 4
  %359 = load float* %In_Reduced.i, align 4
  %360 = load float* %x.i, align 4
  %mul2.i = fmul float %359, %360
  %sub3.i = fsub float 2.000000e+00, %mul2.i
  %mul4.i = fmul float %358, %sub3.i
  store float %mul4.i, float* %x.i, align 4
  %361 = load float* %x.i, align 4
  %362 = load float* %In_Reduced.i, align 4
  %363 = load float* %x.i, align 4
  %mul5.i = fmul float %362, %363
  %sub6.i = fsub float 2.000000e+00, %mul5.i
  %mul7.i = fmul float %361, %sub6.i
  store float %mul7.i, float* %x.i, align 4
  %364 = load float* %x.i, align 4
  %365 = load float* %In_Reduced.i, align 4
  %366 = load float* %x.i, align 4
  %mul8.i = fmul float %365, %366
  %sub9.i = fsub float 2.000000e+00, %mul8.i
  %mul10.i = fmul float %364, %sub9.i
  store float %mul10.i, float* %x.i, align 4
  %367 = load float* %x.i, align 4
  %conv11.i = fptosi float %367 to i128
  %and12.i = and i128 %conv11.i, 8388607
  %368 = load float* %in.addr.i228, align 4
  %conv13.i = fptosi float %368 to i128
  %neg.i = xor i128 %conv13.i, -1
  %and14.i = and i128 %neg.i, 4286578688
  %or15.i = or i128 %and12.i, %and14.i
  %conv16.i = sitofp i128 %or15.i to float
  ...
  %369 = load float* @C_OffsetPhase_pF, align 4
  %sub191 = fsub float %mul190, %369
  %mul192 = fmul float %345, %sub191
  %370 = load i32* @Frequency_number, align 4
  %idxprom193 = sext i32 %370 to i64
...
if.end210:                                        ; preds = %if.end209, %UA_atan.exit
  %382 = load i32* @Current_signal, align 4
  %xor = xor i32 %382, 1
...
if.else222:                                       ; preds = %if.else218
  %387 = load i32* @Cycle_Number, align 4
  %inc223 = add nsw i32 %387, 1
...
if.end227:                                        ; preds = %if.end226, %if.end30
  %388 = load i128** @UA_OUTPUT_TOGGLE_regptr, align 8
  store i128 2048, i128* %388, align 16
  %389 = load i128** @UA_ENABLE_regptr, align 8
  store i128 0, i128* %389, align 16
  br label %while.body
