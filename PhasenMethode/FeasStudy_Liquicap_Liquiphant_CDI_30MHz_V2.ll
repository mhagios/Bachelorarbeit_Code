...
@OneOn_WR = constant [10 x float] [float 0x40459636A0000000, float 0x40558FD040000000, float 0x406599D040000000, float 0x4075954180000000, float 0x40859FD300000000, float 0x40959FD300000000, float 0x40A59636A0000000, float 0x40B59636A0000000, float 0x40C59636A0000000, float 0.000000e+00], align 16
...
if.then211:                                       ; preds = %if.end208
  ...
  store i128 8192, i128* %268, align 16
  %269 = load float* @C_GainAmp_pF, align 4
  %270 = load i32* @Frequency_number, align 4
  %idxprom212 = sext i32 %270 to i64
  %arrayidx213 = getelementptr inbounds [10 x float]* @OneOn_WR, i32 0, i64 %idxprom212
...
UA_sqrt.exit413:                                  ; preds = %if.then.i393, %if.else.i395
  ...
  %arrayidx226 = getelementptr inbounds [10 x float]* @OneOn_WR, i32 0, i64 %idxprom225
...
if.else240:                                       ; preds = %if.end208
  ...
  store i128 8192, i128* %344, align 16
  %345 = load float* @C_GainAmp_pF, align 4
  %346 = load i32* @Frequency_number, align 4
  %idxprom241 = sext i32 %346 to i64
  %arrayidx242 = getelementptr inbounds [10 x float]* @OneOn_WR, i32 0, i64 %idxprom241
...
UA_sqrt.exit:                                     ; preds = %if.then.i, %if.else.i
  ...
  %arrayidx255 = getelementptr inbounds [10 x float]* @OneOn_WR, i32 0, i64 %idxprom254
