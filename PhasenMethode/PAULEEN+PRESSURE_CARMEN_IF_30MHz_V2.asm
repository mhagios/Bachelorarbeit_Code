...
ua_const_63:                    .word         193
ua_const_21:                    .word         6
ua_const_23:                    .word         7
ua_const_62:                    .word         192
ua_const_64:                    .word         9
ua_const_8:                     .word         256
ua_const_6:                     .word         231
ua_const_9:                     .word         230
...
ua_loc_number.addr.i432:        .float        0.0
ua_loc_x2.i436:                 .float        0.0
ua_loc_i_lo.i434:               .int          0x0
ua_loc_i_hi.i435:               .int          0x0
ua_loc_y.i437:                  .float        0.0
ua_loc_in.addr.i406:            .float        0.0
ua_loc_x.i408:                  .float        0.0
...
ua_loc_in.addr.i276:            .float        0.0
ua_loc_x.i278:                  .float        0.0
ua_loc_number.addr.i:           .float        0.0
ua_loc_x2.i:                    .float        0.0
ua_loc_i_lo.i:                  .int          0x0
ua_loc_i_hi.i:                  .int          0x0
ua_loc_y.i:                     .float        0.0
ua_loc_in.addr.i264:            .float        0.0
ua_loc_x.i:                     .float        0.0
ua_loc_in.addr.i368:            .float        0.0
ua_loc_x.i370:                  .float        0.0
ua_loc_number.addr.i328:        .float        0.0
ua_loc_x2.i332:                 .float        0.0
ua_loc_i_lo.i330:               .int          0x0
ua_loc_i_hi.i331:               .int          0x0
ua_loc_y.i333:                  .float        0.0
ua_loc_in.addr.i302:            .float        0.0
ua_loc_x.i304:                  .float        0.0
...
land.lhs.true250:
	...
	JMP | HOLD | HOLD | LOAD @if.else254 LD
if.then253:
...
if.end261:
	JMP | HOLD | HOLD | LOAD @if.end262 LD
land.lhs.true51:
	INC | HOLD | HOLD | LOAD Current_state LD
...
if.end128:
	...
	INC | FMUL ACC LD ACC | HOLD | STOR ua_loc_number.addr.i432 ACC
	INC | HOLD | HOLD | STOR ua_loc_x2.i436 ACC
	INC | HOLD | HOLD | LOAD ua_loc_number.addr.i432 LD
	INC | HOLD | SR LD 1 R0 | LOAD ua_const_37 LD
	INC | MOV R0 ACC | AND R0 LD R0 | LOAD ua_const_38 LD
	INC | HOLD | AND ACC LD R0 | STOR ua_loc_i_lo.i434 R0
	INC | HOLD | HOLD | LOAD ua_const_39 LD
	INC | MOV LD ACC | SR R0 8 R0 | LOAD ua_loc_i_lo.i434 LD
	INC | SUB ACC LD ACC | SR R0 8 R0 | LOAD ua_const_4 LD
	INC | HOLD | MOV ACC R0 | STOR ua_loc_i_hi.i435 R0
	INC | HOLD | HOLD | STOR ua_loc_i_lo.i434 ACC
	JL R0 LD | HOLD | HOLD | LOAD @if.then.i451 LD
	INC | HOLD | HOLD | LOAD ua_const_40 LD
	INC | MOV LD ACC | HOLD | LOAD ua_loc_i_hi.i435 LD
	INC | SUB ACC LD ACC | HOLD | HOLD
	INC | HOLD | HOLD | STOR ua_loc_i_hi.i435 ACC
	JMP | HOLD | HOLD | LOAD @UA_sqrt.exit472 LD
if.then.i451:
	INC | HOLD | HOLD | LOAD ua_const_40 LD
	INC | MOV LD ACC | HOLD | LOAD ua_loc_i_hi.i435 LD
	INC | SUB ACC LD ACC | HOLD | LOAD ua_loc_i_lo.i434 LD
	INC | DEC ACC ACC | HOLD | HOLD
	INC | MOV LD ACC | HOLD | STOR ua_loc_i_hi.i435 ACC
	INC | HOLD | HOLD | LOAD ua_const_37 LD
	INC | HOLD | AND ACC LD R0 | HOLD
	INC | HOLD | HOLD | STOR ua_loc_i_lo.i434 R0
UA_sqrt.exit472:
	INC | HOLD | HOLD | LOAD ua_loc_i_hi.i435 LD
	INC | HOLD | SL LD 8 R0 | LOAD ua_loc_i_lo.i434 LD
	INC | HOLD | SL R0 8 R0 | HOLD
	INC | HOLD | OR R0 LD R0 | LOAD ua_loc_x2.i436 LD
	INC | FMUL LD R0 ACC | HOLD | STOR ua_loc_y.i437 R0
	INC | HOLD | HOLD | LOAD ua_const_41 LD
	INC | FMUL ACC R0 ACC | HOLD | HOLD
	INC | FSUB LD ACC ACC | HOLD | LOAD ua_loc_x2.i436 LD
	INC | FMUL R0 ACC ACC | HOLD | HOLD
	INC | FMUL LD ACC ACC | HOLD | STOR ua_loc_y.i437 ACC
	INC | HOLD | HOLD | LOAD ua_loc_y.i437 LD
	INC | FMUL ACC LD ACC | HOLD | LOAD ua_const_41 LD
	INC | FSUB LD ACC ACC | HOLD | LOAD ua_loc_y.i437 LD
	INC | FMUL LD ACC ACC | HOLD | LOAD ua_loc_x2.i436 LD
	INC | FMUL LD ACC ACC | HOLD | STOR ua_loc_y.i437 ACC
	INC | HOLD | HOLD | LOAD ua_loc_y.i437 LD
	INC | FMUL ACC LD ACC | HOLD | LOAD ua_const_41 LD
	INC | FSUB LD ACC ACC | HOLD | LOAD ua_loc_y.i437 LD
	INC | FMUL LD ACC ACC | HOLD | LOAD ua_loc_number.addr.i432 LD
	INC | FMUL ACC LD ACC | HOLD | STOR ua_loc_y.i437 ACC
	INC | HOLD | MOV ACC R0 | LOAD Current_signal LD
	INC | MOV LD ACC | HOLD | LOAD f_Q1m LD
	INC | MOV LD ACC | HOLD | SOFF Amplitude ACC R0
	INC | HOLD | HOLD | STOR ua_loc_in.addr.i406 LD
	...
	INC | FMUL R0 ACC ACC | HOLD | STOR ua_loc_x.i408 ACC
	INC | FSUB LD ACC ACC | HOLD | LOAD ua_loc_x.i408 LD
	...
	INC | HOLD | AND ACC LD R0 | STOR ua_loc_x.i408 ACC
	INC | MOV R0 ACC | HOLD | LOAD ua_loc_in.addr.i406 LD
...
UA_atan.exit:
	...
	JE R0 LD | HOLD | HOLD | LOAD @if.end246 LD
...
if.end159:
	...
	INC | HOLD | AND ACC LD R0 | STOR ua_loc_in.addr.i276 ACC
	INC | HOLD | HOLD | LOAD ua_const_43 LD
	INC | HOLD | OR R0 LD R0 | LOAD ua_const_44 LD
	INC | FMUL LD R0 ACC | HOLD | LOAD ua_const_45 LD
	INC | FSUB LD ACC ACC | HOLD | LOAD ua_const_46 LD
	INC | FMUL R0 ACC ACC | HOLD | STOR ua_loc_x.i278 ACC
	INC | FSUB LD ACC ACC | HOLD | LOAD ua_loc_x.i278 LD
	INC | FMUL LD ACC ACC | HOLD | LOAD ua_const_46 LD
	INC | FMUL R0 ACC ACC | HOLD | STOR ua_loc_x.i278 ACC
	INC | FSUB LD ACC ACC | HOLD | LOAD ua_loc_x.i278 LD
	INC | FMUL LD ACC ACC | HOLD | LOAD ua_const_46 LD
	...
	INC | FSUB LD ACC ACC | HOLD | LOAD ua_loc_x.i278 LD
	INC | FMUL LD ACC ACC | HOLD | LOAD ua_const_42 LD
	INC | HOLD | AND ACC LD R0 | STOR ua_loc_x.i278 ACC
	INC | MOV R0 ACC | HOLD | LOAD ua_loc_in.addr.i276 LD
	INC | HOLD | MOV LD R0 | LOAD ua_const_47 LD
	INC | HOLD | XOR R0 LD R0 | LOAD ua_const_48 LD
	INC | HOLD | AND R0 LD R0 | LOAD ua_const_49 LD
	INC | HOLD | OR ACC R0 R0 | HOLD
...
UA_sqrt.exit:
	...
	INC | FADD R0 ACC ACC | HOLD | HOLD
	INC | HOLD | AND ACC LD R0 | STOR ua_loc_in.addr.i264 ACC
	INC | HOLD | HOLD | LOAD ua_const_43 LD
	INC | HOLD | OR R0 LD R0 | LOAD ua_const_44 LD
	INC | FMUL LD R0 ACC | HOLD | LOAD ua_const_45 LD
	INC | FSUB LD ACC ACC | HOLD | LOAD ua_const_46 LD
	...
	INC | MOV R0 ACC | HOLD | LOAD ua_loc_in.addr.i264 LD
	INC | HOLD | MOV LD R0 | LOAD ua_const_47 LD
	INC | HOLD | XOR R0 LD R0 | LOAD ua_const_48 LD
	INC | HOLD | AND R0 LD R0 | LOAD ua_const_49 LD
	INC | HOLD | OR ACC R0 R0 | HOLD
...
if.then162:
	...
	INC | FMUL LD ACC ACC | HOLD | LOAD ua_const_50 LD
	INC | FSUB ACC LD ACC | HOLD | LOAD ua_const_36 LD
	INC | FMUL ACC LD ACC | HOLD | STOR ua_loc_number.addr.i328 ACC
	INC | HOLD | HOLD | STOR ua_loc_x2.i332 ACC
	INC | HOLD | HOLD | LOAD ua_loc_number.addr.i328 LD
	INC | HOLD | SR LD 1 R0 | LOAD ua_const_37 LD
	INC | MOV R0 ACC | AND R0 LD R0 | LOAD ua_const_38 LD
	INC | HOLD | AND ACC LD R0 | STOR ua_loc_i_lo.i330 R0
	INC | HOLD | HOLD | LOAD ua_const_39 LD
	INC | MOV LD ACC | SR R0 8 R0 | LOAD ua_loc_i_lo.i330 LD
	INC | SUB ACC LD ACC | SR R0 8 R0 | LOAD ua_const_4 LD
	INC | HOLD | MOV ACC R0 | STOR ua_loc_i_hi.i331 R0
	INC | HOLD | HOLD | STOR ua_loc_i_lo.i330 ACC
	JL R0 LD | HOLD | HOLD | LOAD @if.then.i347 LD
	INC | HOLD | HOLD | LOAD ua_const_40 LD
	INC | MOV LD ACC | HOLD | LOAD ua_loc_i_hi.i331 LD
	INC | SUB ACC LD ACC | HOLD | HOLD
	INC | HOLD | HOLD | STOR ua_loc_i_hi.i331 ACC
	JMP | HOLD | HOLD | LOAD @UA_sqrt.exit367 LD
if.then.i347:
	INC | HOLD | HOLD | LOAD ua_const_40 LD
	INC | MOV LD ACC | HOLD | LOAD ua_loc_i_hi.i331 LD
	INC | SUB ACC LD ACC | HOLD | LOAD ua_loc_i_lo.i330 LD
	INC | DEC ACC ACC | HOLD | HOLD
	INC | MOV LD ACC | HOLD | STOR ua_loc_i_hi.i331 ACC
	INC | HOLD | HOLD | LOAD ua_const_37 LD
	INC | HOLD | AND ACC LD R0 | HOLD
	INC | HOLD | HOLD | STOR ua_loc_i_lo.i330 R0
UA_sqrt.exit367:
	INC | HOLD | HOLD | LOAD ua_loc_i_hi.i331 LD
	INC | HOLD | SL LD 8 R0 | LOAD ua_loc_i_lo.i330 LD
	INC | HOLD | SL R0 8 R0 | HOLD
	INC | HOLD | OR R0 LD R0 | LOAD ua_loc_x2.i332 LD
	INC | FMUL LD R0 ACC | HOLD | STOR ua_loc_y.i333 R0
	INC | HOLD | HOLD | LOAD ua_const_41 LD
	INC | FMUL ACC R0 ACC | HOLD | HOLD
	INC | FSUB LD ACC ACC | HOLD | LOAD ua_loc_x2.i332 LD
	INC | FMUL R0 ACC ACC | HOLD | HOLD
	INC | FMUL LD ACC ACC | HOLD | STOR ua_loc_y.i333 ACC
	INC | HOLD | HOLD | LOAD ua_loc_y.i333 LD
	INC | FMUL ACC LD ACC | HOLD | LOAD ua_const_41 LD
	INC | FSUB LD ACC ACC | HOLD | LOAD ua_loc_y.i333 LD
	INC | FMUL LD ACC ACC | HOLD | LOAD ua_loc_x2.i332 LD
	INC | FMUL LD ACC ACC | HOLD | STOR ua_loc_y.i333 ACC
	INC | HOLD | HOLD | LOAD ua_loc_y.i333 LD
	INC | FMUL ACC LD ACC | HOLD | LOAD ua_const_41 LD
	INC | FSUB LD ACC ACC | HOLD | LOAD ua_loc_y.i333 LD
	INC | FMUL LD ACC ACC | HOLD | LOAD ua_loc_number.addr.i328 LD
	INC | FMUL ACC LD ACC | HOLD | STOR ua_loc_y.i333 ACC
	...
	INC | FMUL ACC LD ACC | HOLD | LOAD ua_const_42 LD
	INC | FADD R0 ACC ACC | HOLD | HOLD
	INC | HOLD | AND ACC LD R0 | STOR ua_loc_in.addr.i302 ACC
	INC | HOLD | HOLD | LOAD ua_const_43 LD
	INC | HOLD | OR R0 LD R0 | LOAD ua_const_44 LD
	INC | FMUL LD R0 ACC | HOLD | LOAD ua_const_45 LD
	INC | FSUB LD ACC ACC | HOLD | LOAD ua_const_46 LD
	INC | FMUL R0 ACC ACC | HOLD | STOR ua_loc_x.i304 ACC
	INC | FSUB LD ACC ACC | HOLD | LOAD ua_loc_x.i304 LD
	INC | FMUL LD ACC ACC | HOLD | LOAD ua_const_46 LD
	INC | FMUL R0 ACC ACC | HOLD | STOR ua_loc_x.i304 ACC
	INC | FSUB LD ACC ACC | HOLD | LOAD ua_loc_x.i304 LD
	INC | FMUL LD ACC ACC | HOLD | LOAD ua_const_46 LD
	...
	INC | FSUB LD ACC ACC | HOLD | LOAD ua_loc_x.i304 LD
	INC | FMUL LD ACC ACC | HOLD | LOAD ua_const_42 LD
	INC | HOLD | AND ACC LD R0 | STOR ua_loc_x.i304 ACC
	INC | MOV R0 ACC | HOLD | LOAD ua_loc_in.addr.i302 LD
	INC | HOLD | MOV LD R0 | LOAD ua_const_47 LD
	INC | HOLD | XOR R0 LD R0 | LOAD ua_const_48 LD
	INC | HOLD | AND R0 LD R0 | LOAD ua_const_49 LD
	INC | HOLD | OR ACC R0 R0 | HOLD
...
if.end241:
	...
	JL R0 LD | HOLD | HOLD | LOAD @if.end246 LD
...
if.end262:
	JMP | HOLD | HOLD | LOAD @if.end263 LD
land.lhs.true:
	INC | HOLD | HOLD | LOAD Current_state LD
	INC | HOLD | MOV LD R0 | LOAD ua_const_0 LD
