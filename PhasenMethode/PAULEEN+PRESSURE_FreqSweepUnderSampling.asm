...
ua_const_24:                    .word         4
ua_const_44:                    .word         15
ua_const_45:                    .float        0.1250000
ua_const_46:                    .float        0.5000000
ua_const_47:                    .word         65535
ua_const_48:                    .word         2147418112
ua_const_49:                    .word         23007
ua_const_50:                    .word         24375
ua_const_51:                    .float        1.500000
...
ua_const_52:                    .float        0.00278569827787578
ua_const_53:                    .float        -0.0158660225570202
ua_const_54:                    .float        0.0424722321331501
ua_const_55:                    .float        -0.0749753043055534
ua_const_56:                    .float        0.106448799371719
ua_const_57:                    .float        -0.142070308327675
ua_const_58:                    .float        0.199934542179108
ua_const_59:                    .float        -0.33333146572113
ua_const_60:                    .float        1.57079637050629
ua_const_61:                    .float        3.14159274101257
ua_const_5:                     .word         28
...
ua_const_41:                    .float        0.999999940395355
ua_const_63:                    .word         2048
...
ua_loc_number.addr.i296:        .float        0.0
ua_loc_x2.i300:                 .float        0.0
ua_loc_i_lo.i298:               .int          0x0
ua_loc_i_hi.i299:               .int          0x0
ua_loc_y.i301:                  .float        0.0
ua_loc_in.addr.i270:            .float        0.0
ua_loc_x.i272:                  .float        0.0
...
land.lhs.true58:
	INC | HOLD | HOLD | LOAD Current_state LD
	INC | HOLD | MOV LD R0 | LOAD ua_const_0 LD
	JE R0 LD | HOLD | HOLD | LOAD @if.then61 LD
...
for.cond:
	...
	JGE R0 LD | HOLD | HOLD | LOAD @for.end85 LD
...
for.cond64:
	...
	JMP | HOLD | HOLD | LOAD @for.cond64 LD
for.end:
	INC | HOLD | HOLD | LOAD Current_signal LD
	INC | HOLD | MOV LD R0 | LOAD ua_const_4 LD
	JE R0 LD | HOLD | HOLD | LOAD @if.then75 LD
	INC | HOLD | HOLD | LOAD Value_index LD
	INC | MOV LD ACC | HOLD | LOAD Temp LD
...
for.cond90:
	INC | HOLD | HOLD | LOAD Value_index LD
	INC | HOLD | MOV LD R0 | LOAD ua_const_43 LD
	JGE R0 LD | HOLD | HOLD | LOAD @for.end127 LD
	INC | HOLD | HOLD | LOAD Current_signal LD
	INC | HOLD | MOV LD R0 | LOAD ua_const_4 LD
	JE R0 LD | HOLD | HOLD | LOAD @if.then96 LD
	INC | HOLD | HOLD | LOAD Value_index LD
	...
	JMP | HOLD | HOLD | LOAD @if.end110 LD
if.then96:
	INC | HOLD | HOLD | LOAD Value_index LD
...
if.end110:
	...
	INC | HOLD | HOLD | STOR Value_index ACC
	JMP | HOLD | HOLD | LOAD @for.cond90 LD
for.end127:
	INC | HOLD | HOLD | LOAD Current_signal LD
	INC | HOLD | MOV LD R0 | LOAD ua_const_4 LD
	...
	JMP | HOLD | HOLD | LOAD @if.end132 LD
if.then130:
	INC | HOLD | HOLD | LOAD f_Q2m LD
...
if.end132:
	...
	INC | FMUL ACC LD ACC | HOLD | STOR ua_loc_number.addr.i296 ACC
	INC | HOLD | HOLD | STOR ua_loc_x2.i300 ACC
	INC | HOLD | HOLD | LOAD ua_loc_number.addr.i296 LD
	INC | HOLD | SR LD 1 R0 | LOAD ua_const_47 LD
	INC | MOV R0 ACC | AND R0 LD R0 | LOAD ua_const_48 LD
	INC | HOLD | AND ACC LD R0 | STOR ua_loc_i_lo.i298 R0
	INC | HOLD | HOLD | LOAD ua_const_49 LD
	INC | MOV LD ACC | SR R0 8 R0 | LOAD ua_loc_i_lo.i298 LD
	INC | SUB ACC LD ACC | SR R0 8 R0 | LOAD ua_const_4 LD
	INC | HOLD | MOV ACC R0 | STOR ua_loc_i_hi.i299 R0
	INC | HOLD | HOLD | STOR ua_loc_i_lo.i298 ACC
	JL R0 LD | HOLD | HOLD | LOAD @if.then.i315 LD
	INC | HOLD | HOLD | LOAD ua_const_50 LD
	INC | MOV LD ACC | HOLD | LOAD ua_loc_i_hi.i299 LD
	INC | SUB ACC LD ACC | HOLD | HOLD
	INC | HOLD | HOLD | STOR ua_loc_i_hi.i299 ACC
	JMP | HOLD | HOLD | LOAD @UA_sqrt.exit336 LD
if.then.i315:
	INC | HOLD | HOLD | LOAD ua_const_50 LD
	INC | MOV LD ACC | HOLD | LOAD ua_loc_i_hi.i299 LD
	INC | SUB ACC LD ACC | HOLD | LOAD ua_loc_i_lo.i298 LD
	INC | DEC ACC ACC | HOLD | HOLD
	INC | MOV LD ACC | HOLD | STOR ua_loc_i_hi.i299 ACC
	INC | HOLD | HOLD | LOAD ua_const_47 LD
	INC | HOLD | AND ACC LD R0 | HOLD
	INC | HOLD | HOLD | STOR ua_loc_i_lo.i298 R0
UA_sqrt.exit336:
	INC | HOLD | HOLD | LOAD ua_loc_i_hi.i299 LD
	INC | HOLD | SL LD 8 R0 | LOAD ua_loc_i_lo.i298 LD
	INC | HOLD | SL R0 8 R0 | HOLD
	INC | HOLD | OR R0 LD R0 | LOAD ua_loc_x2.i300 LD
	INC | FMUL LD R0 ACC | HOLD | STOR ua_loc_y.i301 R0
	INC | HOLD | HOLD | LOAD ua_const_51 LD
	INC | FMUL ACC R0 ACC | HOLD | HOLD
	INC | FSUB LD ACC ACC | HOLD | LOAD ua_loc_x2.i300 LD
	INC | FMUL R0 ACC ACC | HOLD | HOLD
	INC | FMUL LD ACC ACC | HOLD | STOR ua_loc_y.i301 ACC
	INC | HOLD | HOLD | LOAD ua_loc_y.i301 LD
	INC | FMUL ACC LD ACC | HOLD | LOAD ua_const_51 LD
	INC | FSUB LD ACC ACC | HOLD | LOAD ua_loc_y.i301 LD
	INC | FMUL LD ACC ACC | HOLD | LOAD ua_loc_x2.i300 LD
	INC | FMUL LD ACC ACC | HOLD | STOR ua_loc_y.i301 ACC
	INC | HOLD | HOLD | LOAD ua_loc_y.i301 LD
	INC | FMUL ACC LD ACC | HOLD | LOAD ua_const_51 LD
	INC | FSUB LD ACC ACC | HOLD | LOAD ua_loc_y.i301 LD
	INC | FMUL LD ACC ACC | HOLD | LOAD ua_loc_number.addr.i296 LD
	INC | FMUL ACC LD ACC | HOLD | STOR ua_loc_y.i301 ACC
	INC | HOLD | MOV ACC R0 | LOAD Current_signal LD
	INC | MOV LD ACC | HOLD | LOAD f_Q1m LD
	INC | MOV LD ACC | HOLD | SOFF Amplitude ACC R0
	INC | HOLD | HOLD | STOR ua_loc_in.addr.i270 LD
	...
	INC | FMUL R0 ACC ACC | HOLD | STOR ua_loc_x.i272 ACC
	INC | FSUB LD ACC ACC | HOLD | LOAD ua_loc_x.i272 LD
	...
	INC | HOLD | AND ACC LD R0 | STOR ua_loc_x.i272 ACC
	INC | MOV R0 ACC | HOLD | LOAD ua_loc_in.addr.i270 LD
...
if.end3.i:
	...
	INC | HOLD | HOLD | LOAD ua_loc_r.i LD
	INC | FNEG LD ACC | HOLD | LOAD ua_const_60 LD
...
UA_atan.exit:
	...
	INC | FSUB LD ACC ACC | HOLD | LOAD ua_loc_x.i235 LD
	INC | FMUL LD ACC ACC | HOLD | LOAD ua_const_6 LD
	INC | HOLD | AND ACC LD R0 | STOR ua_loc_x.i235 ACC
	INC | MOV R0 ACC | HOLD | LOAD ua_loc_in.addr.i233 LD
	INC | HOLD | MOV LD R0 | LOAD ua_const_11 LD
	INC | HOLD | XOR R0 LD R0 | LOAD ua_const_12 LD
	INC | HOLD | AND R0 LD R0 | LOAD ua_const_13 LD
	INC | HOLD | OR ACC R0 R0 | HOLD
	INC | FMUL R0 LD ACC | HOLD | LOAD ua_tmp_221 LD
	INC | FMUL LD ACC ACC | HOLD | LOAD ua_const_15 LD
	INC | FSUB ACC LD ACC | HOLD | LOAD ua_const_46 LD
...
UA_sqrt.exit:
	...
	INC | MOV LD ACC | HOLD | STOR ua_tmp_287 ACC
	INC | HOLD | HOLD | LOAD Q1mRef LD
	INC | FMUL ACC LD ACC | HOLD | LOAD Q2mSig LD
	INC | MOV LD ACC | MOV ACC R0 | LOAD Q2mRef LD
	INC | FMUL ACC LD ACC | HOLD | LOAD ua_const_6 LD
	INC | FADD R0 ACC ACC | HOLD | HOLD
	INC | HOLD | AND ACC LD R0 | STOR ua_loc_in.addr.i197 ACC
	INC | HOLD | HOLD | LOAD ua_const_7 LD
	INC | HOLD | OR R0 LD R0 | LOAD ua_const_8 LD
	INC | FMUL LD R0 ACC | HOLD | LOAD ua_const_9 LD
	INC | FSUB LD ACC ACC | HOLD | LOAD ua_const_10 LD
	INC | FMUL R0 ACC ACC | HOLD | STOR ua_loc_x.i199 ACC
	INC | FSUB LD ACC ACC | HOLD | LOAD ua_loc_x.i199 LD
	INC | FMUL LD ACC ACC | HOLD | LOAD ua_const_10 LD
	INC | FMUL R0 ACC ACC | HOLD | STOR ua_loc_x.i199 ACC
	INC | FSUB LD ACC ACC | HOLD | LOAD ua_loc_x.i199 LD
	INC | FMUL LD ACC ACC | HOLD | LOAD ua_const_10 LD
	...
	INC | FSUB LD ACC ACC | HOLD | LOAD ua_loc_x.i199 LD
	INC | FMUL LD ACC ACC | HOLD | LOAD ua_const_6 LD
	INC | HOLD | AND ACC LD R0 | STOR ua_loc_x.i199 ACC
	INC | MOV R0 ACC | HOLD | LOAD ua_loc_in.addr.i197 LD
	INC | HOLD | MOV LD R0 | LOAD ua_const_11 LD
	INC | HOLD | XOR R0 LD R0 | LOAD ua_const_12 LD
	INC | HOLD | AND R0 LD R0 | LOAD ua_const_13 LD
	INC | HOLD | OR ACC R0 R0 | HOLD
	INC | FMUL R0 LD ACC | HOLD | LOAD ua_tmp_287 LD
	INC | FMUL LD ACC ACC | HOLD | LOAD f32OneOn_W2L LD
	...
	INC | HOLD | MOV LD R0 | LOAD ua_const_4 LD
	JE R0 LD | HOLD | HOLD | LOAD @if.then172 LD
	INC | HOLD | HOLD | LOAD ua_const_2 LD
	...
	JMP | HOLD | HOLD | LOAD @if.end179 LD
if.then172:
	INC | HOLD | HOLD | LOAD ua_const_2 LD
	INC | HOLD | HOLD | STOR 0x409 LD
	INC | HOLD | HOLD | LOAD ua_const_0 LD
...
land.lhs.true:
	...
	JMP | HOLD | HOLD | LOAD @if.else55 LD
if.then:
	INC | HOLD | HOLD | LOAD Current_signal LD
	INC | HOLD | MOV LD R0 | LOAD ua_const_4 LD
...
if.end39:
	...
	INC | FMUL LD R0 ACC | HOLD | LOAD ua_const_9 LD
	INC | FSUB LD ACC ACC | HOLD | LOAD ua_const_10 LD
	INC | FMUL R0 ACC ACC | HOLD | STOR ua_loc_x.i342 ACC
	INC | FSUB LD ACC ACC | HOLD | LOAD ua_loc_x.i342 LD
	INC | FMUL LD ACC ACC | HOLD | LOAD ua_const_10 LD
	INC | FMUL R0 ACC ACC | HOLD | STOR ua_loc_x.i342 ACC
	INC | FSUB LD ACC ACC | HOLD | LOAD ua_loc_x.i342 LD
	INC | FMUL LD ACC ACC | HOLD | LOAD ua_const_10 LD
	...
	INC | FSUB LD ACC ACC | HOLD | LOAD ua_loc_x.i342 LD
	INC | FMUL LD ACC ACC | HOLD | LOAD ua_const_6 LD
	INC | HOLD | AND ACC LD R0 | STOR ua_loc_x.i342 ACC
